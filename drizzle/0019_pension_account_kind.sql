...
-- added its transfer value to cash. Where the pension is most of the balance
-- sheet, that makes spendable money read as an order of magnitude more than
-- it is, the bulk of it a pension that cannot be drawn on until the plan is
-- left. The new kind is what lets it be valued in net worth and still be kept
-- out of "assets".
--
