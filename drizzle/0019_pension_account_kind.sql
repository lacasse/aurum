...
-- added its transfer value to cash: on this record that made [figure redacted] of
-- spendable money read as [figure redacted], nine tenths of it a pension that cannot
