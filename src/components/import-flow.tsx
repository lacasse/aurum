 ...
 *
 * It is a dialog on the Transactions page rather than a page of its own:
 * importing a statement is adding transactions, and it ends by leaving you
 * looking at the list it just added to.
 */
